					...
					<div>
						<div class="border-b border-gray-200">
							<div class="-mb-px flex space-x-8" aria-orientation="horizontal" role="tablist">
								<button
									id="tab-reviews"
									class="whitespace-nowrap border-b-2 border-transparent py-6 text-sm font-medium text-gray-700 hover:border-gray-300 hover:text-gray-800"
						...
						>
							...
							<div class="flex space-x-4 text-sm text-gray-500">
								...
								<div class="py-10">
									<h3 class="font-medium text-slate-100">Emily Selman</h3>
							...
							<div class="flex space-x-4 text-sm text-gray-500">
								...
								<div class="border-t border-gray-200 py-10">
									<h3 class="font-medium text-slate-100">Hector Gibbons</h3>
									...
									<div class="prose-sm prose mt-4 max-w-none text-gray-500">
										<p>
											Blown away by how polished this icon pack is. Everything looks so consistent
											and each SVG is optimized out of the box so I can use it directly with
											confidence. It would take me several hours to create a single icon this good,
						...
						>
							...
							<dl>
								<dt class="mt-10 font-medium text-slate-100">What format are these icons?</dt>
								...
								<dt class="mt-10 font-medium text-slate-100">
